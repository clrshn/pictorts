    ...
    <div class="table-card">
        ...
        <div style="padding:24px;">
            <div style="display:grid; grid-template-columns: 1fr 1fr; gap:8px 32px; font-size:13px;">
                ...
                <div><strong>Priority:</strong> <span class="badge" style="background:{{ $todo->priority_color }}; color:white;">{{ $todo->priority_badge }}</span></div>
                ...
                @if($todo->description)
                    <div style="grid-column:span 2;"><strong>Description:</strong></div>
                    <div style="grid-column:span 2; margin-top:4px; padding:12px; background:#f8f9fa; border-radius:4px; line-height:1.5;">
                        {{ $todo->description }}
                    </div>
                @endif
            </div>
