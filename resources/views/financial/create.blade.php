<x-app-layout>
    ...
    <div class="table-card">
        ...
        <div style="padding:24px;">
            <p style="font-size:12px; color:#999; margin-bottom:16px;">Reference code will be auto-generated upon saving, using the format PICTO-FIN-YEAR-SEQUENCE.</p>
                ...
                <div style="display:grid; grid-template-columns: 1fr 1fr; gap:16px;">
                    <div class="form-group">
                        ...
                        <select name="type" class="form-control">
                            ...
                            <option value="LIQUIDATION" {{ old('type') === 'LIQUIDATION' || old('type') === 'LIQUADATION' ? 'selected' : '' }}>LIQUIDATION</option>
                            ...
                            <option value="PR,PO" {{ old('type') === 'PR,PO' ? 'selected' : '' }}>PR,PO</option>
                        </select>
                    </div>
                    <div class="form-group">
